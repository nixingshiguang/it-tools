...
// node_modules/.pnpm/@it-tools+oggen@1.3.0/node_modules/@it-tools/oggen/dist/index.mjs
var twitterCompatibility = {
...
var isObject = (v) => typeof v === "object" && !Array.isArray(v) && v !== null && !(v instanceof Date);
var toSnakeCase = (s) => s.split(":").map(toSnakeCaseStrict).join(":");
var toSnakeCaseStrict = (s) => {
  var _a;
  return ((_a = s.match(/[A-Z]{2,}(?=[A-Z][a-z]+[0-9]*|\b)|[A-Z]?[a-z]+[0-9]*|[A-Z]|[0-9]+/g)) == null ? void 0 : _a.map((x) => x.toLowerCase()).join("_")) ?? "";
};
...
//# sourceMappingURL=@it-tools_oggen.js.map
