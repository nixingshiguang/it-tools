import {
  require_base64_js,
  require_ieee754
} from "./chunk-KEYIH7ZD.js";
import {
  require_lib
} from "./chunk-U3RXL63A.js";
import "./chunk-EAQREBZC.js";
import {
  __commonJS
} from "./chunk-2LSFTFF7.js";

// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/VerifyPDFError.js
var require_VerifyPDFError = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/VerifyPDFError.js"(exports, module) {
    var TYPE_UNKNOWN = "TYPE_UNKNOWN";
    var TYPE_INPUT = "TYPE_INPUT";
    var TYPE_PARSE = "TYPE_PARSE";
    var TYPE_BYTE_RANGE = "TYPE_BYTE_RANGE";
    var VERIFY_SIGNATURE = "VERIFY_SIGNATURE";
    var UNSUPPORTED_SUBFILTER = "UNSUPPORTED_SUBFILTER";
    var VerifyPDFError = class extends Error {
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/packages/buffer/index.js
var require_buffer = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/packages/buffer/index.js"(exports) {
    "use strict";
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/general.js
var require_general = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/general.js"(exports, module) {
    var forge = require_lib();
    var { Buffer } = require_buffer();
    var VerifyPDFError = require_VerifyPDFError();
    var preparePDF = (pdf) => {
      try {
    ...
    var checkForSubFilter = (pdfBuffer) => {
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/extractSignature.js
var require_extractSignature = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/extractSignature.js"(exports, module) {
    var { Buffer } = require_buffer();
    var VerifyPDFError = require_VerifyPDFError();
    var { getSignatureMeta, preparePDF } = require_general();
    var DEFAULT_BYTE_RANGE_PLACEHOLDER = "**********";
    var getByteRange = (pdfBuffer) => {
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/certsUtils.js
var require_certsUtils = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/certsUtils.js"(exports, module) {
    var issued = (cert) => (anotherCert) => cert !== anotherCert && anotherCert.issued(cert);
    var getIssuer = (certsArray) => (cert) => certsArray.find(issued(cert));
    var inverse = (f) => (x) => !f(x);
    var hasNoIssuer = (certsArray) => inverse(getIssuer(certsArray));
    var getChainRootCertificateIdx = (certsArray) => certsArray.findIndex(hasNoIssuer(certsArray));
    var isIssuedBy = (cert) => (anotherCert) => cert !== anotherCert && cert.issued(anotherCert);
    var getChildIdx = (certsArray) => (parent) => certsArray.findIndex(isIssuedBy(parent));
    var sortCertificateChain = (certs) => {
    ...
    var getClientCertificate = (certs) => sortCertificateChain(certs)[0];
    module.exports = {
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/rootCAs.json
var require_rootCAs = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/rootCAs.json"(exports, module) {
    module.exports = [
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/verification.js
var require_verification = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/verification.js"(exports, module) {
    var tls = require_tls();
    var forge = require_lib();
    var rootCAs = require_rootCAs();
    var getRootCAs = () => tls.rootCertificates || rootCAs;
    var verifyRootCert = (chainRootInForgeFormat) => !!getRootCAs().find((rootCAInPem) => {
      try {
        const rootCAInForgeCert = forge.pki.certificateFromPem(rootCAInPem);
        return forge.pki.certificateToPem(chainRootInForgeFormat) === rootCAInPem || rootCAInForgeCert.issued(chainRootInForgeFormat);
      } catch (e) {
        return false;
      }
    });
    var verifyCaBundle = (certs) => !!certs.find((cert, i) => certs[i + 1] && certs[i + 1].issued(cert));
    var isCertsExpired = (certs) => !!certs.find(({ validity: { notAfter, notBefore } }) => notAfter.getTime() < Date.now() || notBefore.getTime() > Date.now());
    var authenticateSignature = (certs) => verifyCaBundle(certs) && verifyRootCert(certs[certs.length - 1]);
    module.exports = {
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/index.js
var require_helpers = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/helpers/index.js"(exports, module) {
    var extractSignature = require_extractSignature();
    var certsUtils = require_certsUtils();
    var generalHelpers = require_general();
    var verificationHelpers = require_verification();
    module.exports = {
      extractSignature,
      ...certsUtils,
      ...generalHelpers,
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/certificateDetails.js
var require_certificateDetails = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/certificateDetails.js"(exports, module) {
    var forge = require_lib();
    var {
      extractSignature,
      getMessageFromSignature,
    ...
    var mapEntityAtrributes = (attrs) => attrs.reduce((agg, { name, value }) => {
      if (!name)
        return agg;
      agg[name] = value;
      return agg;
    }, {});
    var extractSingleCertificateDetails = (cert) => {
    ...
    var extractCertificatesDetails = (certs) => certs.map(extractSingleCertificateDetails).map((cert, i) => {
      if (i)
        return cert;
      return {
    ...
    var getCertificatesInfoFromPDF = (pdf) => {
      const pdfBuffer = preparePDF(pdf);
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/verifyPDF.js
var require_verifyPDF = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/verifyPDF.js"(exports, module) {
    var forge = require_lib();
    var VerifyPDFError = require_VerifyPDFError();
    var {
      extractSignature,
    ...
    var { extractCertificatesDetails } = require_certificateDetails();
    var verify = (signature, signedData, signatureMeta) => {
      ...
      const digest = forge.md[hashAlgorithm].create().update(forge.asn1.toDer(set).data).digest().getBytes();
      ...
      const dataDigest = forge.md[hashAlgorithm].create().update(signedData.toString("latin1")).digest().getBytes();
...
// node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/index.js
var require_pdf_signature_reader = __commonJS({
  "node_modules/.pnpm/pdf-signature-reader@1.4.2/node_modules/pdf-signature-reader/index.js"(exports, module) {
    var verifyPDF = require_verifyPDF();
    var { getCertificatesInfoFromPDF } = require_certificateDetails();
    Object.assign(verifyPDF, { getCertificatesInfoFromPDF });
    module.exports = verifyPDF;
  }
});
export default require_pdf_signature_reader();
/*! Bundled license information:

pdf-signature-reader/packages/buffer/index.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=pdf-signature-reader.js.map
