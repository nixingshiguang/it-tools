...
declare type BodyAttributes = BaseBodyAttributes & BodyEvents;
...
declare type DefinedValueOrEmptyObject<T extends undefined | Record<string, any>> = [T] extends [undefined] ? ({}) : T;
...
declare type Script = ScriptBase & HttpEventAttributes;
...
declare type TagKey = keyof Head;
interface HeadTag {
    tag: TagKey;
...
export { AriaAttributes, Base, BaseBodyAttributes, BodyAttributes, BodyEvents, Booleanable, DataKeys, DefinedValueOrEmptyObject, EventAttributes, GlobalAttributes, Head, HeadTag, HtmlAttributes, HttpEventAttributes, Link, LinkBase, LinkRelTypes, Merge, MergeHead, Meta, MetaFlat, MetaFlatInput, MetaNames, MetaProperties, Noscript, Script, ScriptBase, Stringable, Style, StyleEntries, TagKey };
