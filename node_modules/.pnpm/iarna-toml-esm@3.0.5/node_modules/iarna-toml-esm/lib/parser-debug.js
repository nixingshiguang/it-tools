'use strict'
import Parser, { Error } from './parser.js'
import { inspect } from 'util'

const dump = _ => inspect(_, {colors: true, depth: 10, breakLength: Infinity})
class DebugParser extends Parser {
  ...
  finish () {
    ...
    if (this.stack.length !== 0) {
      throw new Error('All states did not return by end of stream')
    }
    return obj
  }
  callStack () {
